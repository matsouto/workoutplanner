...
public class Chest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("C H E S T  &  T R I  &  S H O U L");
        ...
        DatabaseReference mRef = mDatabase.getReference().child("users").child(mAuth.getUid()).child("chestList");
        // Toast.makeText(Chest.this,"Loading Your Exercises!",Toast.LENGTH_SHORT).show();
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                CustomAdapter mCustomAdapter = new CustomAdapter(Chest.this,exercises);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Toast.makeText(Chest.this, exercise_to_delete + " done!", Toast.LENGTH_SHORT).show();
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(Chest.this, exercise_to_delete + " removed from database!", Toast.LENGTH_SHORT).show();
                                mCustomAdapter.notifyDataSetChanged();
                ...
                if (exercises.isEmpty()){
                    Toast.makeText(Chest.this,"You Don't Have Exercises!",Toast.LENGTH_SHORT).show();
                }
    ...
    public void openExerciseCreatorChest() {
        Intent intent = new Intent(this, ExerciseCreatorChest.class);
