...
public class ExerciseCreatorChest extends AppCompatActivity {
    ...
    public void buildExercise () {
        ...
        if (!TextUtils.isEmpty(exercise.getExercise_name()) ||
            ...
            mRef.child("users").child(mAuth.getUid()).child("chestList").child(exercise.getExercise_name()).setValue(exercise);
