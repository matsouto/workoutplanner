...
public class Legs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference mRef = mDatabase.getReference().child("users").child(mAuth.getUid()).child("legsList");
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                CustomAdapter mCustomAdapter = new CustomAdapter(Legs.this,exercises);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Toast.makeText(Legs.this, exercise_to_delete + " done!", Toast.LENGTH_SHORT).show();
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(Legs.this, exercise_to_delete + " removed from database!", Toast.LENGTH_SHORT).show();
                                mCustomAdapter.notifyDataSetChanged();
                ...
                if (exercises.isEmpty()){
                    Toast.makeText(Legs.this,"You Don't Have Exercises!",Toast.LENGTH_SHORT).show();
                }
    ...
    public void openExerciseCreatorChest() {
        Intent intent = new Intent(this, ExerciseCreatorLegs.class);
